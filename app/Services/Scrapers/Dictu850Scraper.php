...
//                echo '<pre>'; print_r($dataTm); exit;
            ...
            if ($this->smalotPdfHelper->textWithinDataTm($dataTm, 'EISEN BIJ DEZE AANVRAAG')) {
                ...
                $textWithin = $page->getTextXY(407, $coordsFromCompetenties[1] - 25, 10, 25);
                ...
                $textWithin = $page->getTextXY(407, $coordsFromAk[1] - 25, 10, 25);
                ...
                $textWithin = $page->getTextXY(832, $coordsFromWish3[1] - 25, 25, 25);
